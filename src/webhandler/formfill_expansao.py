...
def formfill_expansao(handler: WebHandler, infolist: DataFrame, filelist: list[str]) -> None:
    ...
    handler.get_element('EXPANSAO_FILEBTN', 'AGORA').click()
    handler.get_element('EXPANSAO_FILEFORM', 'MEDIA', None, None, filelist)
    handler.get_element('EXPANSAO_FILESEND', 'AGORA').click()
